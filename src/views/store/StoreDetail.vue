...
<script type="text/ecmascript-6">
  ...
  import { pr, realPx } from '../../utils/utils'
  ...
  export default {
    ...
    methods: {
      ...
      itemStyle(item) {
        return {
          marginLeft: (item.deep - 1) * pr(20) + 'rem'
        }
      },
  ...
  .book-detail {
    ...
    .content-wrapper {
      ...
      .book-detail-content-wrapper {
        width: 100%;
        border-bottom: pr(1) solid #eee;
        box-sizing: border-box;
        .book-detail-content-title {
          font-size: pr(20);
          font-weight: bold;
          padding: pr(20) pr(15) pr(10) pr(15);
          box-sizing: border-box;
        }
    ...
    .bottom-wrapper {
      ...
      width: 100%;
      height: pr(52);
      box-shadow: 0 pr(-2) pr(2) rgba(0, 0, 0, .1);
      .bottom-btn {
        flex: 1;
        color: $color-blue;
        font-weight: bold;
